...
import ru.alexanurin.chialexanurinfinalexam.databinding.FragmentAddNoteBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.button.setOnClickListener {
            if (binding.editText.text.toString().trim().isNotEmpty()) {
                ...
                Toast.makeText(requireActivity(), R.string.empty_not_saved, Toast.LENGTH_LONG).show()
            }
        }
    }
